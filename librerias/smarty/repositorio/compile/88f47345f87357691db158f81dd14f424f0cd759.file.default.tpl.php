<?php /* Smarty version Smarty-3.1.11, created on 2016-05-23 13:12:23
		...
		<aside class="main-sidebar">
			...
			<!-- sidebar menu: : style can be found in sidebar.less -->
				<ul class="sidebar-menu">
					...
					<?php }?>
					<?php if ($_smarty_tpl->tpl_vars['PAGE']->value['usuario']->getIdTipo()!=3){?>
					<li class="<?php if (in_array($_smarty_tpl->tpl_vars['PAGE']->value['modulo'],array('cicloescolar','grupos','cuidados','niveles','planestudio','asignaturas'))){?>active<?php }?> treeview">
						<a href="#">
						...
						<ul class="treeview-menu">
							...
							<?php }?>
							<li <?php if ($_smarty_tpl->tpl_vars['PAGE']->value['modulo']=='planestudio'||$_smarty_tpl->tpl_vars['PAGE']->value['modulo']=='asignaturas'){?>class="active"<?php }?>><a href="planestudios"><i class="fa fa-folder"></i> Plan de estudios</a></li>
						</ul>
					</li>
					<?php }?>
					<?php if ($_smarty_tpl->tpl_vars['PAGE']->value['usuario']->getIdTipo()!=3){?>
					...
					<li class="<?php if (in_array($_smarty_tpl->tpl_vars['PAGE']->value['modulo'],array('reportesEstudiantes','reportesVentas'))){?>active<?php }?> treeview">
						<a href="#">
							<span>Reportes</span> <i class="fa fa-angle-left pull-right"></i>
						</a>
						<ul class="treeview-menu">
							<li <?php if ($_smarty_tpl->tpl_vars['PAGE']->value['modulo']=='reportesEstudiantes'){?>class="active"<?php }?>><a href="reportesEstudiantes"><i class="fa fa-graduation-cap"></i> Estudiantes</a></li>
							<li <?php if ($_smarty_tpl->tpl_vars['PAGE']->value['modulo']=='reportesVentas'){?>class="active"<?php }?>><a href="reportesVentas"><i class="fa fa-shopping-cart"></i> Ventas</a></li>
						</ul>
					</li>
				</ul>
			</section>
