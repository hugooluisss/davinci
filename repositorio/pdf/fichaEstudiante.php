 ...
 */
class RFichaEstudiante extends tFPDF{
	private $cotizacion;
	
	public function RFichaEstudiante(){
	...
	public function Header(){   	
    	...
    	$this->Ln(10);
    	$this->Image('repositorio/formato/fichaEstudiante.jpg', 10, 10, 200, 255);
	...
	public function generar($id){
		...
		$aux = $db->Execute("select count(*) as total from inscripcion where idEstudiante = ".$id);
		
		$estudiante = new TEstudiante($id);
